        ...
        <div class="col-lg-12">
            <div class="p-5">
                <div class="text-center">
                    <img class="img-profile rounded-circle" src="{{ url('/img/account.png') }}"style="width: 90px; height: 90px; margin-bottom: 20px"> <br>
                    <span class="h3 text-gray-900 mb-4" >Jordan House</span>
                    <br>
                     <br>
                </div>
